...
var SHORTCUTS = [
  ...
  { id: 'soql',       aliases: 'soql',                   label: '@soql',     sublabel: 'Ask a data question',           group: 'ai',          action: 'soql-generator', hint: 'Press Enter to open the SOQL generator',
    tipTitle: '@soql — SOQL from plain English', tipBody: 'Describe your query in natural language. Requires an AI provider key.',       tipExample: '@soql accounts with no opportunity\n  in the last 6 months' },
